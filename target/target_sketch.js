...
export var extension_run = function (key) {
	if (arguments.length) {
		var __ilastarg0__ = arguments.length - 1;
		if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
			var __allkwargs0__ = arguments [__ilastarg0__--];
...
var setup = function () {
	...
	var grid = Grid (50, stroke, line);
	extensions [grid.shortcut] = grid;
	var bezier = Bezier (desenha_bezier);
	...
	background (0);
	frameRate (12);
	for (var ext of extensions.py_items ()) {
		ext [1].setup ();
	}
};
...
export var loadFile = function (file) {
	if (arguments.length) {
		var __ilastarg0__ = arguments.length - 1;
		if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
			var __allkwargs0__ = arguments [__ilastarg0__--];
...
var keyReleased = function () {
	...
	if (extensions.py_get (key) !== null) {
		extensions [key].run ();
	}
};
export var curve = function (x1, x2, x3, x4) {
	if (arguments.length) {
		var __ilastarg0__ = arguments.length - 1;
		if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
			var __allkwargs0__ = arguments [__ilastarg0__--];
...
var mouseClicked = function () {
	...
	var px = mouseX;
	var py = mouseY;
	var gird = extensions ['g'];
	var __left0__ = gird.get_grid (px, py);
	var px = __left0__ [0];
	var py = __left0__ [1];
	if (px < 0) {
		return ;
...
export var desenha_bezier = function () {
	if (arguments.length) {
		var __ilastarg0__ = arguments.length - 1;
		if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
			var __allkwargs0__ = arguments [__ilastarg0__--];
