// Transcrypt'ed from Python, 2023-01-01 21:28:31
...
var draw = function () {
	...
	if (size > 3) {
		if (extensions ['b'].enable) {
			stroke ('purple');
			bezier (last_points [last] [0], last_points [last] [1], last_points [last + 1] [0], last_points [last + 1] [1], last_points [last + 2] [0], last_points [last + 2] [1], last_points [last + 3] [0], last_points [last + 3] [1]);
		}
	}
};
