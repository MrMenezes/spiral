...
var __name__ = 'bezier';
export var BezierExtension =  __class__ ('BezierExtension', [object], {
	__module__: __name__,
	get __init__ () {return __get__ (this, function (self, run_func) {
		if (arguments.length) {
			...
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				...
				for (var __attrib0__ in __allkwargs0__) {
					switch (__attrib0__) {
						...
						case 'run_func': var run_func = __allkwargs0__ [__attrib0__]; break;
					}
				}
			}
		}
